...
function Kavo:ToggleUI()
    ...
    if screenGui then
        ...
        game.TweenService:Create(screenGui.Main, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
            Size = UDim2.new(0, 0, 0, 0)
        }):Play()
        
        wait(0.2)  -- Aguarda a animação terminar
        screenGui.Enabled = false  -- Esconde o painel após animação
    else
        -- Se o painel não está visível, mostramos com animação
        local newScreenGui = game.CoreGui:FindFirstChild(LibName)
        if newScreenGui then
            newScreenGui.Enabled = true
            game.TweenService:Create(newScreenGui.Main, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
